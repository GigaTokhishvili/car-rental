  ...
  return (
    <div className='vehicle' key={nanoid()}>
        ...
        <div className='vehicle-button'>
            <Link to='/' className="main-button vehicle-button-btn">Book Ride</Link>
        </div>
    </div>
  )
}
